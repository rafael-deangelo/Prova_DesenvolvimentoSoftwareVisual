...
namespace API_Folha.Migrations
{
    ...
    [Migration("20221004152953_TabelaFolhaPagamentos")]
    partial class TabelaFolhaPagamentos
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API_Folha.Models.FolhaPagamento", b =>
                {
            ...
            modelBuilder.Entity("API_Folha.Models.Funcionario", b =>
                {
                    b.Property<int>("FuncionarioId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("API_Folha.Models.FolhaPagamento", b =>
                {
                    b.HasOne("API_Folha.Models.Funcionario", "Funcionario")
                        .WithMany()
